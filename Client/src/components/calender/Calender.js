...
class Calendar extends React.Component {
  ...
  componentDidMount = async () => {
    const { data } = await axios.get('http://localhost:5050/api/bookVenue');
    console.log(data);
...
//THINGS TO DO
//PUT CLICKED CALENDER IN STATE
//PASS IT TO PARENT
//SEND IT WHEN BOOK IS CLICKED



// EXTRA
// SHOW ORANGES WHEN DATE IS CLICKED