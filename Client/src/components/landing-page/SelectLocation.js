    ...
    return (
        <div className="container selectLocation">
            ...
            <div className='row location'>
                <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4 pt-md-1 pr-md-1 mb-3'>
                        <img src = {location1} className="img centered "/>
                        <p> Abuja </p>
                </div>
                <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4 pr-md-1 mb-3'>
                ...
                <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4 mt-md-n2 pr-md-1 mb-3'>
                ...
                <div className='col-xs-12 col-sm-6 col-md-4 col-lg-4 mt-md-n2 mb-3'>
